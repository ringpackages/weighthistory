...
int main(int argc, char *argv[])
{
    ...
    ringapp_delete_file(path,"weighthistory.ringo");

    // Copy Ring Object File (weighthistory.ringo) from Resources to Temp Folder
    QString path2 ;
    path2 = path+"/weighthistory.ringo";
    QFile::copy(":/weighthistory.ringo",path2);
    ...
    ring_state_runobjectfile(pRingState,"weighthistory.ringo");
